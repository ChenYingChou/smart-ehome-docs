...
```
**==20200417異動==**
參考 [App 登入取得 MQTT 通訊時所需的資訊](../系統架構設計/通訊協定/Web%20API.md#app-登入取得-mqtt-通訊時所需的資訊-login)
...
> **icon_id** : 為萬用表單（080)時，`img_id` 才會有效，代表該頁 icon 圖示(預設為 086 圖示)。
> **moduleID** : 模組的ID，不同模組會有相同 deviceID，非萬用表單時使用。     
