...
本功能為 [MQTT 通訊協定 - 查詢伺服器下各模組設備組態](./MQTT%20通訊協定.md#查詢伺服器下各模組設備組態) 中原有功能，只是改用 Web API 查詢。
...
1. 網頁伺服器回覆:
    ...
    * 成功時 `payload` 內容詳見 [MQTT 通訊協定 - 伺服器回應各模組/設備組態](./MQTT%20通訊協定.md#伺服器回應各模組設備組態)。
...
本功能為 [MQTT 通訊協定 - 查詢模組/設備/功能最新狀態](./MQTT%20通訊協定.md#查詢模組設備功能最新狀態) 中原有功能，只是改用 Web API 查詢。
...
1. 網頁伺服器回覆:
    ...
    * 成功時 `payload` 內容詳見 [MQTT 通訊協定 - 回應指定時間點後各模組/設備/功能最新狀態](./MQTT%20通訊協定.md#回應指定時間點後各模組設備功能最新狀態)。
...
本功能為 [MQTT 通訊協定 - 查詢系統模組情境/智慧控制/排程各功能內容](./MQTT%20通訊協定.md#查詢系統模組情境智慧控制排程各功能內容) 中原有功能，只是改用 Web API 查詢。
...
1. 網頁伺服器回覆:
    ...
    * 成功時 `payload` 內容詳見 [MQTT 通訊協定 - 系統模組回應查詢情境/智慧控制/排程各功能內容](./MQTT%20通訊協定.md#系統模組回應查詢情境智慧控制排程各功能內容)。
...
本功能為 [MQTT 通訊協定 - 異動系統模組情境/智慧控制/排程各功能內容](./MQTT%20通訊協定.md#異動系統模組情境智慧控制排程各功能內容) 中原有功能，只是改用 Web API 查詢。
...
1. App 送出 `POST` 資料如下:
    ...
    * `_payload_` 內容因 `SCENES`(情境)、`WISDOMS`(智慧控制)、`SCHEDULES`(排程) 而不同，詳細說明參見 [MQTT 通訊協定 - 系統模組回應查詢情境/智慧控制/排程各功能內容](./MQTT%20通訊協定.md#系統模組回應查詢情境智慧控制排程各功能內容)。
